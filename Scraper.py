...
# Purpose           : A script that will find retreive data from yahoo
#                     by scraping its html and saving in a .csv file
...
#html files are stored in the directory 
path = ('C:/Users/Aaron/Downloads/intraQuarter')

#function to scrape the data and save it in an excel file
#the features used for the machine learning are under gather
def Key_Stats(gather=["Total Debt/Equity",
    ...
    #create a pandas dataframe, retreive tickers from filenames
...
##        starting_sp500_value = False
        ...
        #loop as long as the file name is existent
        if len(each_file) > 0:
            for file in each_file:
                ...
                try:
                    value_list = []
                    #use regular expressions to scrape the html file
                    ...
                    #very messy code :(
                    #keep looping through the try and excepts, retreive date, data and the s&p 500 closing value
                    try:
...
##                        time.sleep(1555)
                    ...
                    #find the changes in stock prices over the span of a year in %
                    ...
                    #label data as over or under perfoming
                    if difference > 0:
                        status = "outperform"
                    else:
                        status = "underperform"
                    ...
                    if value_list.count("N/A") > 15:
                        ...
                        #append all data to the data frame
